...
<?php include('partials-front/menu.php'); ?>
    ...
    <section class="food-search">
        <div class="container">
            ...
            <h2 class="text-center text-white">在下面完成您的订单</h2>
            ...
            <form action="" method="POST" class="order">
                ...
                <fieldset>
                    ...
                    <textarea name="address" rows="10" placeholder="例如: 16栋212" class="input-responsive" required></textarea>
            ...
            <?php 
                ...
                if(isset($_POST['submit']))
                {
                    ...
                    if($res2==true)
                    {
                        ...
                        $_SESSION['order'] = "<div class='success text-center'>下单成功请等待派送.</div>";
                        header('location:'.SITEURL);
                    }
                    else
                    {
